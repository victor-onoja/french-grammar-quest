export const levels = [
  ...
  },
  {
    ...
    lesson: `<h2>Devoir and its many facets</h2><p>Il y a (there is, there are) Il y a is an impersonal expression that means both there is and there are. Il y a un chat sur le canapé. There is a cat on the sofa. Il n’y a plus rien dans le frigo. There is nothing left in the fridge. Il y a is used in a variety of expressions. Qu’est-ce qu’ il y a ? What’s the matter? Il n’y a qu’à leur dire. Just tell them. Il y avait une fois... Once upon a time . . . Il y a cinquante kilomètres d’ici à Paris. It’s fifty kilometers from here to Paris. Il y en a qui feraient mieux de se taire. Some people would do better to keep quiet. Il s’agit de (it is a matter of, it’s about) Il s’agit de (it is a matter of, it’s about) is a fixed expression that introduces the subject of a work (book, film, play).</p>`,
    exercises: [
